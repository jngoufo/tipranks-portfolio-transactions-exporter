...
- **Le script plante ou est bloqué** : L'interface web de TipRanks peut parfois être lente à charger. Le script patiente, mais si la page bugue, vous pouvez arrêter le script en faisant `Ctrl + C` dans le terminal, puis le relancer avec `node export.js`.
